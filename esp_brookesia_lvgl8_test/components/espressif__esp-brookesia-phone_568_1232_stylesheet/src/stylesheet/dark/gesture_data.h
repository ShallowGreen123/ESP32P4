...
#define ESP_BROOKESIA_PHONE_568_1232_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA() \
    {                                                                     \
        .main = {                                                         \
...
#define ESP_BROOKESIA_PHONE_568_1232_DRAK_GESTURE_BOTTOM_INDICATOR_BAR_DATA() \
    {                                                                 \
        .main = {                                                     \
...
#define ESP_BROOKESIA_PHONE_568_1232_DARK_GESTURE_DATA()                                   \
    {                                                                              \
        .detect_period_ms = 20,                                                    \
        .threshold = {                                                             \
        ...
        .indicator_bars = {                                                        \
            [ESP_BROOKESIA_GESTURE_INDICATOR_BAR_TYPE_LEFT] =                             \
                ESP_BROOKESIA_PHONE_568_1232_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(), \
            [ESP_BROOKESIA_GESTURE_INDICATOR_BAR_TYPE_RIGHT] =                            \
                ESP_BROOKESIA_PHONE_568_1232_DRAK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(), \
            [ESP_BROOKESIA_GESTURE_INDICATOR_BAR_TYPE_BOTTOM] =                           \
                ESP_BROOKESIA_PHONE_568_1232_DRAK_GESTURE_BOTTOM_INDICATOR_BAR_DATA(),     \
        },                                                                         \
        .flags = {                                                                 \
