...
IRAM_ATTR bool display_vsync_cb(esp_lcd_panel_handle_t handle, esp_lcd_dpi_panel_event_data_t *edata, void *user_ctx)
{
...
IRAM_ATTR static bool example_notify_lvgl_flush_ready(esp_lcd_panel_handle_t panel, esp_lcd_dpi_panel_event_data_t *edata, void *user_ctx)
{
...
void app_main(void)
{
    ...
    esp_lcd_panel_handle_t rm69a10_ctrl_panel;
    ...
    esp_lcd_dpi_panel_event_callbacks_t cbs = {
        .on_color_trans_done = display_vsync_cb,
        .on_refresh_done = example_notify_lvgl_flush_ready,
    };
    ...
    size_t draw_buffer_sz = ALIGN_UP_BY(EXAMPLE_MIPI_DSI_LCD_H_RES * EXAMPLE_MIPI_DSI_LCD_V_RES * LV_COLOR_DEPTH / 8, data_cache_line_size);
    ESP_ERROR_CHECK(esp_lcd_dpi_panel_get_frame_buffer(mipi_dpi_panel, 2, &buf1, &buf2));
    ...
    BaseType_t ret = xTaskCreatePinnedToCore(example_lvgl_port_task, "lvgl", EXAMPLE_LVGL_TASK_STACK_SIZE, NULL,
                                             EXAMPLE_LVGL_TASK_PRIORITY, &lvgl_task_handle, core_id);
