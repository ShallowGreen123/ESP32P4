...
/* Home */
#define ESP_BROOKESIA_PHONE_568_1232_DARK_HOME_DATA()                                     \
    {                                                                             \
        .status_bar = {                                                           \
            .data = ESP_BROOKESIA_PHONE_568_1232_DARK_STATUS_BAR_DATA(),                  \
            .visual_mode = ESP_BROOKESIA_STATUS_BAR_VISUAL_MODE_SHOW_FIXED,              \
        },                                                                        \
        .navigation_bar = {                                                       \
            .data = ESP_BROOKESIA_PHONE_568_1232_DARK_NAVIGATION_BAR_DATA(),              \
            .visual_mode = ESP_BROOKESIA_NAVIGATION_BAR_VISUAL_MODE_SHOW_FLEX,           \
        },                                                                        \
        .app_launcher = {                                                         \
            .data = ESP_BROOKESIA_PHONE_568_1232_DARK_APP_LAUNCHER_DATA(),                \
        },                                                                        \
        .recents_screen = {                                                       \
            .data = ESP_BROOKESIA_PHONE_568_1232_DARK_RECENTS_SCREEN_DATA(),              \
...
/* Manager */
#define ESP_BROOKESIA_PHONE_568_1232_DARK_MANAGER_DATA()             \
    {                                                        \
        .gesture = ESP_BROOKESIA_PHONE_568_1232_DARK_GESTURE_DATA(), \
...
/* Phone */
#define ESP_BROOKESIA_PHONE_568_1232_DARK_STYLESHEET()               \
    {                                                        \
        .core = ESP_BROOKESIA_PHONE_568_1232_DARK_CORE_DATA(),       \
        .home = ESP_BROOKESIA_PHONE_568_1232_DARK_HOME_DATA(),       \
        .manager = ESP_BROOKESIA_PHONE_568_1232_DARK_MANAGER_DATA(), \
    }
