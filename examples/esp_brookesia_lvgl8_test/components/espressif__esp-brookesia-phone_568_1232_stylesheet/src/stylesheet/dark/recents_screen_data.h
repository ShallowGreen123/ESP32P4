...
LV_IMG_DECLARE(esp_brookesia_phone_568_1232_recents_screen_trash_image);

#define ESP_BROOKESIA_PHONE_568_1232_DARK_RECENTS_SCREEN_SNAPSHOT_DATA() \
    {                                                            \
        .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(340, 800),           \
        .title = {                                               \
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(340, 100),        \
        ...
        .image = {                                               \
            .main_size = ESP_BROOKESIA_STYLE_SIZE_RECT(340, 700),       \
            .radius = 20,                                        \
        },                                                       \
    }

#define ESP_BROOKESIA_PHONE_568_1232_DARK_RECENTS_SCREEN_DATA()                                    \
    {                                                                                      \
        .main = {                                                                          \
        ...
        .snapshot_table = {                                                                \
            ...
            .snapshot = ESP_BROOKESIA_PHONE_568_1232_DARK_RECENTS_SCREEN_SNAPSHOT_DATA(),          \
        },                                                                                 \
        .trash_icon = {                                                                    \
            .default_size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(48),                                  \
            .press_size = ESP_BROOKESIA_STYLE_SIZE_SQUARE(43),                                    \
            .image = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_phone_568_1232_recents_screen_trash_image), \
        },                                                                                 \
        .flags = {                                                                         \
            .enable_memory = 1,                                                            \
