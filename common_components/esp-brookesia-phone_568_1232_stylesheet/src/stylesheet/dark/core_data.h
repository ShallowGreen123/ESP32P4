...
LV_IMG_DECLARE(esp_brookesia_phone_568_1232_wallpaper_image_drak);

/* Home */
#define ESP_BROOKESIA_PHONE_568_1232_DARK_CORE_HOME_DATA()                                                      \
    {                                                                                                   \
        .background = {                                                                                 \
            .color = ESP_BROOKESIA_STYLE_COLOR(0x1A1A1A),                                                      \
            .wallpaper_image_resource = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_phone_568_1232_wallpaper_image_drak), \
        },                                                                                              \
        .text = {                                                                                       \
...
/* Core */
#define ESP_BROOKESIA_PHONE_568_1232_DARK_CORE_INFO_DATA_NAME    "568x1232 Drak"
#define ESP_BROOKESIA_PHONE_568_1232_DARK_CORE_DATA()                     \
    {                                                             \
        .name = ESP_BROOKESIA_PHONE_568_1232_DARK_CORE_INFO_DATA_NAME,    \
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(568, 1232),          \
        .home = ESP_BROOKESIA_PHONE_568_1232_DARK_CORE_HOME_DATA(),       \
        .manager = ESP_BROOKESIA_PHONE_568_1232_DARK_CORE_MANAGER_DATA(), \
    }
